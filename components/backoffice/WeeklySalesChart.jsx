                ...
                <ul className="flex flex-wrap -mb-px">
                    {
                        tabs.map((tab,i)=>{
                            return (
                                ...
                                <button onClick={()=>setChatTobDisplay(tab.type)} href="#" className={chartTodDisplay==tab.type? 
                                    "inline-block p-4 text-orange-600 border-b-2 border-orange-600 rounded-t-lg active dark:text-orange-500 dark:border-orange-500":"inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-700 text-slate-500 hover:border-gray-100 dark:hover:text-gray-300"
                                }>{tab.title}</button>
                            </li>
                            );
