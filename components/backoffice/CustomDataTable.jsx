...
export default function CustomDataTable() {
  ...
  return (
    <div className='mt-8'>
            <h2 className='text-xl dark:text-slate-50 text-slate-800 font-bold mb-4'>Recent Orders</h2>
            {/* Table */}
                            ...
                            <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-14">
                                ...
                                </li>
                                {
                                    Array.from({length:totalPages}, (_, index) => {
                                        return (
                                            <li key={index}>
                                    <button onClick={() => setCurrentPage(index + 1)}  disabled= {currentPage == index+1} className={currentPage == index+1 ?"flex items-center justify-center px-3 h-8 leading-tight text-gray-50 bg-blue-600 border border-blue-300 hover:bg-blue-800 hover:text-white dark:bg-green-600 dark:border-green-600 dark:text-slate-50 dark:hover:bg-gray-700 dark:hover:text-white":"flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"} >{index + 1}</button>
                                </li>
                                        )
                                    })
                                }
