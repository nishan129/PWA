  ...
  return (
    <form className='flex items-center'>
        ...
        <div className='relative w-full'>
            ...
            <input type="text" id='voice-search' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full ps-10 p-2.5 dark:bg-slate-50 dark:border-green-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-600 dark:focus:border-green-600'
